    ...
    <script>
        ...
        alert("Fichier HLS envoyé avec succès sur Backblaze !");
                 */
                 ...
                 let currentIndex = 0; // Compteur pour le fichier actuel


                  // Étape 3 : Envoyer tous les fichiers
        for (let file of files) {

               let percent = ((currentIndex + 1) / totalFiles) * 100;

               console.log(percent,(currentIndex + 1),totalFiles)
