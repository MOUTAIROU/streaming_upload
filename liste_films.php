...
<body>
   ...
   async function fetchActeurs() {
        ...
        try {
            const response = await fetch("http://localhost:8090/film/getfilmliste", {
                method: "GET",
                headers: {
            ...
            acteurs.forEach(acteur => {
                ...
                listItem.innerHTML = `
                    <div class="acteurs-container">
                     ...
                     <div>
                     <h3> Categorie : ${acteur.categorie}</h3>
                     ...
                     <h3> scenes : ${acteur.scenes} / Langue : ${acteur.langue} / Time : ${acteur.time}</h3>
                        ...
                        <div class="acteurs-container-a">
                            ...
                            <a href ="enregistrer-un-film-modifier.php?filmID=${acteur.film_id}&title=${acteur.title}&image=${acteur.image}&image2=${acteur.image2}&des=${acteur.description}&categorie=${acteur.categorie}">Voir les information </a>
 ...
 //   setInterval(fetchActeurs, 20000);
    ...
    function formatNumber(n) {
     ...
     document.getElementById('searchForm').addEventListener('submit', async function(event) {
            ...
            try {
                const response = await fetch("http://localhost:8090/film/searchfilm", {
                    method: "POST",
                    headers: {
                        "Accept": "application/json",
                        "Content-Type": "application/json"
